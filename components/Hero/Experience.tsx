      ...
      >
        ...
        <ul className='list-decimal'>
          ...
          <li className="py-5">
            ...
            <p className="font-mono">Full Stack Development Intern</p>
            <p className="font-mono"><i>December 2022 - November 2023</i></p>
            <ul className='list-disc list-inside font-mono'>
            ...
            <a href="https://brototype.com" target="_blank" rel="noopener noreferrer" className={buttonClass}>Company Website</a>
            <a href="https://linkedin.com/company/brototype" target="_blank" rel="noopener noreferrer" className={buttonClass}>LinkedIn</a>
          </li>
        </ul>
      </div>
    </div>
